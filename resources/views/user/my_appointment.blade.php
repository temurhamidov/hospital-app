...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{url('/')}}"><span class="text-primary">Temur</span>-Health</a>
...
<div align="center" style="padding: 70px;">
    ...
    <table>
        ...
        <tr style="background-color: black;" align="center">
            ...
            <td><a class="btn btn-danger" onclick="return confirm('Ishonchingiz komilmi buni uchirishga')" href="{{url('cancel_appoint', $appoints->id)}}">Cancel</a></td>
        </tr>
